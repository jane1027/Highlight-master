...
public class HighLight {
    ...
    public void show() {
        ...
        skipView = LayoutInflater.from(mContext).inflate(R.layout.view_skip, null);
        TextView skipText = (TextView) skipView.findViewById(R.id.skip_text);
        ...
        if (mAnchor.getClass().getSimpleName().equals("FrameLayout")) {
            ...
            ((ViewGroup) mAnchor).addView(skipView);
        } else {
